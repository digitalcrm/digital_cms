  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('admin/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin_CMS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo (Auth::user()->picture != NULL) ? url(Auth::user()->picture) : url("uploads/default/user1.png"); ?>" class="img-profile rounded-circle" alt="Admin Image" width="32" height="32">
        </div>
        <div class="info">
    ...
    <div class="sidebar-menu">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{url('leads')}}" class="nav-link {{ Request::is('leads*')? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{url('forecast')}}" class="nav-link {{ Request::is('forecast*')? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{url('territory')}}" class="nav-link {{ Request::is('territory*')? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview {{ request()->is('*mails*') ? 'menu-open' : '' }} {{ request()->is('*campaigns*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link nav-dropdown-toggle {{ request()->is('*mails*') ? 'active' : '' }} {{ request()->is('*campaigns*') ? 'active' : '' }}">
                        <i class="nav-icon far fa-envelope"></i>
                        <p>
                            Mails
                            <i class="fas fa-angle-left right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('mails')}}" class="nav-link {{ Request::is('mails*')? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Webmail</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{url('reports/leads')}}" class="nav-link {{ Request::is('reports/*')? 'active' : '' }}">
                        <i class="nav-icon fas fa-chart-pie"></i>
                        <p>Reports</p>
                    </a>
                </li>
